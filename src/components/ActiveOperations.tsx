  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <h2 className="text-sm font-semibold text-gray-500 tracking-wide">Live Operations</h2>
      ...
      <div className="grid lg:grid-cols-3 gap-4">
        ...
        <div className="bg-white rounded-2xl shadow-sm overflow-hidden">
          <div className="px-4 py-3 border-b border-gray-100 flex items-center justify-between">
            <h3 className="text-sm font-bold text-gray-800">Active Buses</h3>
          ...
          <div className="divide-y divide-gray-50 max-h-64 overflow-y-auto">
            {data.buses.map(b => (
              <div key={b.id} className="px-4 py-3">
                ...
                <div className="text-[10px] text-gray-400">Driver: {b.driver}</div>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm overflow-hidden">
          <div className="px-4 py-3 border-b border-gray-100 flex items-center justify-between">
            <h3 className="text-sm font-bold text-gray-800">Station Workers</h3>
            ...
            {data.stationWorkers.map(w => (
              <div key={w.id} className="px-4 py-3">
                <div className="flex items-center justify-between gap-2">
                  ...
                  <Badge label={w.dutyStatus} variant="success" />
                </div>
            ...
            {data.drivers.map(d => (
              <div key={d.id} className="px-4 py-3">
                <div className="flex items-center justify-between gap-2">
                  ...
                  <Badge label="On Route" variant="warning" />
                </div>
                <div className="text-xs text-gray-500 mt-1">Driver · {d.route}</div>
        ...
        <div className="bg-white rounded-2xl shadow-sm overflow-hidden">
          <div className="px-4 py-3 border-b border-gray-100 flex items-center justify-between">
            <h3 className="text-sm font-bold text-gray-800">Routes In Use</h3>
            ...
            {data.routes.map(r => (
              <div key={r.id} className="px-4 py-3">
                ...
                <div className="flex gap-3 mt-1.5 text-[10px] text-gray-400">
                  <span>{r.busesActive} bus(es)</span>
                  <span>{r.driversOnDuty} driver(s)</span>
